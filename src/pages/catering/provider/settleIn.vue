    ...
    <div class="status" v-else>
      ...
      <div class="payment" v-else>
        ...
        <div class="agreement">
          ...
          <p>
            1.
            商家在有播甄选参与经营活动必须缴纳服务保证金，保证金主要用于保证商家直播带货符合法律法规及有播甄选的平台规定。
          </p>
          <p>
            2.
          ...
          <p>
            3.
            有播甄选有权根据商家的业务变化及实际违约赔付情况通知商家调整保证金金额，商家应在收到有播甄选通知后的3个工作日内补足保证金，如果没有及时补足保证金金额的，有播甄选有权中止合作。
          </p>
          <p>
            4.
            商家缴纳的保证金将冻结在商家的有播甄选企业账户中，在冻结期内保证金不产生利息，有播甄选不开具发票。
          </p>
          <p>
            5.
            商家需要退出有播甄选，终止合作，需向有播甄选提出保证金退还申请，有播甄选审核通过后会在30天内将保证金原路退回到您缴纳保证金时的支付账户。商家退出时存在前期违约金尚未支付的情况的，有播甄选从保证金余额中扣取。
          </p>
          <p>
            6.
            因重大违规被清退的商家将不退还保证金，因违规行为扣取的保证金不退还，作为商家违约金赔偿给用户及有播甄选，具体保证金扣取情况参见《平台商家违规管理规则》。
          </p>
          <p>
            7.
            有播甄选将根据国家经济情况、市场状况及有播甄选经营情况，适时适当调整保证金制度。保证金制度的调整会按相关规定提前公示予以所有商家。
          </p>
        </div>
